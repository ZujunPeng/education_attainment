...
<script src="https://d3js.org/d3.v6.js"></script>  <!-- link to D3 library -->
  ...
  <label for="vehicle3"> Some College or Associate Degree </label><br><br>
  <input type="checkbox" id="bachelor" value="bachelor">
  <label for="vehicle3"> Bachelor's Degree</label><br><br>
  <input type="checkbox" id="advanced" value="advanced">
  <label for="vehicle3"> Graduate or Professional Degree</label><br><br>
...
<script>
  var w = 530;
  var h = 550;
  var margin = {top: 25, right: 0, bottom: 25,left: 30};
  ...
  function drawline(data,ID,color,svg_){
	...
	function update1(){
		  if(d3.select("input#lessHS").property("checked")){
		    drawline(lessHS,"lesshs","#edf8fb",svg);
		  }else{
	...
	function update4(){
	  if(d3.select("input#bachelor").property("checked")){
		    drawline(bachelor,"bachelors","#8856a7",svg);
		}else{
