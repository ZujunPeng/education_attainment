...
statesDFrame<-na.omit(statesDFrame)
statesDF<- data.frame(unique(statesDFrame$bachelor_higher))
...
panelDesc <- data.frame(                 
    type=c("mapmedian","id","dot"),  
    lab1=c("","","Rate of Bachelor Degree or Higher in 2019"),   
    lab2=c("","","Rate of Bachelor Degree or Higher"), 
    col1=c(NA,NA,1),                 
    col2=c(NA,NA,NA)		
    )
