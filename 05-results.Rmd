...
vcd::mosaic(dt, direction = c("v", "h"),highlighting_fill=c("#edf8fb","#b3cde3"), labeling = labeling_border(rot_labels = c(45, 0), abbreviate_labs = c(2, 1)),main= "Mosaic Plot of Educaton Attainment and Gender")
```
