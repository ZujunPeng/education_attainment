...
Now, let us look at the different levels of education attainment by race in the United States. Different from the previous plot, in this plot, the levels of educational attainment are "Total", "Higher School or Higher", and "Bachelor Degree or Higher", represent the total population, people have a high school or higher degree, and people with a bachelor or higher degree respectively.
```{r, echo = FALSE}
