...
abbreviate <- function(ds, total = FALSE, race = FALSE){
    ...
    if(total){
      ds$Education <- fct_relevel(ds$Education,"< High School","High School Graduate","Some Colleges","Bachelor Degree", "Advanced Degree","Total")
    }
    if(!total&&!race){
      ds$Education<-fct_relevel(ds$Education,"< High School","High School Graduate","Some Colleges","Bachelor Degree", "Advanced Degree")

    }
    if(race){
      ds$Education<-fct_relevel(ds$Education,"Total",">= High School",">= Bachelor Degree")
    }
    return(ds)
}
```
