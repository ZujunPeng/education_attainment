...
abbreviate <- function(ds, educ = TRUE, race = FALSE){
    if (educ){
        ds$Education[which(ds$Education == "Less.than.high.school.graduate")] <- "< High School"
    ...
    if (race){
        ds$Education[which(ds$Education == "High.school.graduate.or.higher")] <- ">= High School"
        ds$Education[which(ds$Education == "Bachelor.s.degree.or.higher")] <- ">= Bachelor Degree"
